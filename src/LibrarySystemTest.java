public class LibrarySystemTest {
    public static void main(String[] args) {
        ...
        Book book2 = new Book("B002", "Clean Code", "Robert C. Martin", "9780132350884", 464, "Software Engineering");

        Magazine mag1 = new Magazine("M001", "Tech Today", "Editor Smith", 101, "June", true);
        Magazine mag2 = new Magazine("M002", "Science Monthly", "Editorial Board", 45, "May", false);
